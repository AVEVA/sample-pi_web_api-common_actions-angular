...
export class PIWebAPIService {
  ...
  apiResponse = { callURIText: '', codeResult: '', returnCode: 0 };
  ...
  createDatabase(
    ...
    try {
      ...
      let httpOptions = this.callHeaders(
        userName,
        userPassword,
        authType,
        false
      ...
      let callURI: string =
        piWebAPIUrl + '/assetservers?path=\\\\' + assetServer;
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        switchMap((result) => {
          ...
          callURI =
            result[this.resultBody][this.resultLinks][this.resultSelf] +
            '/assetdatabases';
  ...
  createCategory(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Category ' + this.categoryName + ' created';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
  ...
  createTemplate(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        switchMap((template) => {
          callURI =
            template[this.resultBody][this.resultLinks][this.resultSelf] +
            '/attributetemplates';
          //  Write the URI we're about to call to the textarea in the UI
          this.apiResponse.callURIText +=
          ...
          const makeActiveAttr$ = this.makePostRequest(
            callURI,
            {
              Name: this.activeAttributeName,
              Description: '',
          ...
          const makeOSAttr$ = this.makePostRequest(
            callURI,
            {
              Name: 'OS',
              Description: 'Operating System',
          ...
          const makeOSVersionAttr$ = this.makePostRequest(
            callURI,
            {
              Name: 'OSVersion',
              Description: 'Operating System Version',
          ...
          const makeIPAddressAttr$ = this.makePostRequest(
            callURI,
            {
              Name: 'IPAddresses',
          ...
          this.apiResponse.callURIText +=
            '\n\nPOST ' +
            this.sinusoidUAttributeName +
            ' attribute request body:\n' +
            JSON.stringify(
              {
                Name: this.sinusoidUAttributeName,
                Description: '',
          ...
          //  Add Sinusoid U
          const makeSinusoidUAttr$ = this.makePostRequest(
            callURI,
            {
              Name: this.sinusoidUAttributeName,
              Description: '',
          ...
          this.apiResponse.callURIText +=
            '\n\nPOST ' +
            this.sinusoidAttributeName +
            ' attribute request body:\n' +
            JSON.stringify(
              {
                Name: this.sinusoidAttributeName,
                Description: '',
                IsConfigurationItem: false,
                Type: 'Double',
                DataReferencePlugIn: 'PI Point',
          ...
          //  Add Sinusoid
          const makeSinusoidAttr$ = this.makePostRequest(
            callURI,
            {
              Name: this.sinusoidAttributeName,
              Description: '',
          ...
          this.apiResponse.callURIText +=
            '\n\nPOST ' +
            this.sampleTagAttributeName +
            ' request body:\n' +
            JSON.stringify(
              {
                Name: this.sampleTagAttributeName,
                Description: '',
                IsConfigurationItem: false,
                Type: 'Double',
                DataReferencePlugIn: 'PI Point',
          ...
          const makeSampleTagAttr$ = this.makePostRequest(
            callURI,
            {
              Name: this.sampleTagAttributeName,
              Description: '',
  ...
  createElement(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        switchMap(() => {
          this.apiResponse.codeResult =
            'Equipment ' + this.elementName + ' created';
        ...
        switchMap((elementResponse) => {
          callURI =
            piWebAPIUrl +
            '/elements/' +
            elementResponse[this.resultBody][this.resultWebId] +
            '/config';
          //  Write the URI we're about to call to the textarea in the UI
          this.apiResponse.callURIText +=
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        switchMap((result) => {
          callURI =
            piWebAPIUrl +
            '/streams/' +
            result[this.resultBody][this.resultWebId] +
            '/recorded';
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Attribute ' + this.sampleTagAttributeName + ' streamed 100 values';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        switchMap((result) => {
          ...
          //  Write the URI we're about to call to the textarea in the UI
          this.apiResponse.callURIText +=
            '\nPOST Request URI to update the ' +
            this.activeAttributeName +
            ' attribute value: ' +
            callURI;
          this.apiResponse.callURIText +=
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Attribute ' + this.activeAttributeName + ' value set to true';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
  ...
  readSingleValue(
    ...
    try {
      const httpOptions = this.callHeaders(
        userName,
        userPassword,
        authType,
        false
  ...
  deleteElement(
    ...
    try {
      ...
      //  Write the URI we're about to call to the textarea in the UI
      this.apiResponse.callURIText =
        'GET Request URI to retrieve the element: ' + callURI;
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Element ' + this.elementName + ' Deleted';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
  ...
  deleteTemplate(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Template ' + this.templateName + ' deleted';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
  ...
  deleteCategory(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Category ' + this.categoryName + ' deleted';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
  ...
  deleteDatabase(
    ...
    try {
      ...
      return this.makeGetRequest(callURI, httpOptions).pipe(
        ...
        map((response) => {
          this.apiResponse.codeResult =
            'Database ' + this.databaseName + ' deleted';
          this.apiResponse.returnCode = response[this.returnStatus];
          return this.apiResponse;
        }),
        catchError((error) => {
